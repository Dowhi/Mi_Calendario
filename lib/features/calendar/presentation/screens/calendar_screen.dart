...
class _CalendarScreenState extends ConsumerState<CalendarScreen> {
  ...
  void didChangeDependencies() {
    ...
    try {
      ...
      print('✅ CalendarDataService inicializado correctamente');
    } catch (e) {
      print('❌ Error inicializando CalendarDataService: $e');
      // Si es el error específico de iOS Safari, mostrar mensaje específico
      if (e.toString().contains('minified:JG') || e.toString().contains('minified:k')) {
        print('🔍 Error de compatibilidad iOS Safari detectado');
      }
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                isIOSCompatibilityError 
                  ? 'Problema de compatibilidad con iOS Safari. Intenta usar Chrome o actualizar Safari.'
                    ...
                    return Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 16),
                          ...localUsers.map((user) {
                            // Obtener el usuario activo actual del provider
                            ...
                            return ListTile(
                              ...
                              tileColor: isSelected ? user.color.withOpacity(0.1) : null,
                              onTap: () {
